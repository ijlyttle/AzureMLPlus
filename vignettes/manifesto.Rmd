...
- `url`, `success`, `request_timestamp`, `request_body`, `response_timestamp`, `response_body`, : `function(request_response)`

- `extract_data`: `function(response_body, response_sample, ...)`
